...
// Credits: https://www.youtube.com/watch?v=3CycKKJiwis
// Art of Code
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec3 bgCol = vec3(0.156);
    vec3 shiftColour = vec3(0.2 + 0.25 * sin(iTime), 0.4, 0.1);
    col = bgCol + vec3(line) * rand(uv) + vec3(line) * 0.6 * shiftColour;
    col = mix(col, bgCol, length(uv) * 0.9);
