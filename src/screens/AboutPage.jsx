      ...
      <Box section="section" sx={{ p: 1, m: 1 }} display="flex" flexDirection="column" justifyContent="center" alignItems="center">
        <Box style={{ width: pageWidth }}>
          <Box section="section" sx={{ my: 2 }}>
            ...
            <Typography variant="body1">My name's Van Andrew and I'm a final year CS undergrad at the University of New South Wales.</Typography>
            ...
            <Typography variant="body1">In my spare time I like working on new shaders and competing in brazilian jiu jitsu.</Typography>
          </Box>
          <Box section="section" sx={{ mt: 1 }}>
            <Typography variant="body1">Things I'm comfortable working with:</Typography>
          </Box>
