...
function draw() {
  ...
  // Start Drawing
  d = 80 + 4*sin(frameCount / 64) + micLevel*500;
  
  // Middle
  strokeWeight(1.5 + 0.4*sin(frameCount/32));
  stroke(67,34,34);
  fill(255);
  circle(canvasWidth/2, canvasHeight/2, 64+10 + 4*sin(frameCount/64-8));
  fill(244, 191,213);
  ...
  stroke(67,34,34);
  fill(255);
  circle(canvasWidth/2 - d, canvasHeight/2, 48+8 + 4*sin(frameCount/48-4));
  circle(canvasWidth/2 + d, canvasHeight/2, 48+8 + 4*sin(frameCount/48-4));
  circle(canvasWidth/2, canvasHeight/2 + d, 48+8 + 4*sin(frameCount/48-4));
  circle(canvasWidth/2, canvasHeight/2 - d, 48+8 + 4*sin(frameCount/48-4));
  fill(240, 153,174);
  ...
  stroke(67,34,34);
  fill(255);
  circle(canvasWidth/2 - d*2, canvasHeight/2, 32+6 + 4*sin(frameCount/32-4));
  circle(canvasWidth/2 + d*2, canvasHeight/2, 32+6 + 4*sin(frameCount/32-4));
  circle(canvasWidth/2, canvasHeight/2 + d*2, 32+6 + 4*sin(frameCount/32-4));
  circle(canvasWidth/2, canvasHeight/2 - d*2, 32+6 + 4*sin(frameCount/32-4));
  fill(213, 128,144);
